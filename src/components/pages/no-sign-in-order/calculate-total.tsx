...
export const CalculateTotal = () => {
  ...
  return (
    <div className="flex items-center rounded-xl bg-slate-800 px-3 pb-5 pt-9">
      <div className="relative w-fit">
        <div className="absolute -top-5 left-1 text-sm">Total</div>
        <div className="w-24 rounded-lg bg-slate-900 px-2 py-1">{total}</div>
      </div>
      ...
      <div className="relative ml-4 w-fit">
        ...
        <div className="w-32 rounded-lg bg-slate-900 px-2 py-1 text-center text-2xl">
          {shopOwnerPay}
        </div>
      </div>
    </div>
...
const ShipFeeInput = ({ noSignInOrder }: { noSignInOrder: NoSignInOrder }) => {
  ...
  return (
    <div className="relative w-fit">
      ...
      <input
        className="w-24 rounded-lg bg-slate-900 px-2 py-1 hover:border-gray-600"
        type="number"
